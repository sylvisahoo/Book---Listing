...
class AddEditBookScreen extends StatefulWidget {
  ...
  const AddEditBookScreen({super.key, required this.bookProvider});
...
class _AddEditBookScreenState extends State<AddEditBookScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    bool success;
    if (_isEditMode) {
      success = await widget.bookProvider.editBook(
        _existingBook!.id,
        fields,
        _selectedImagePath,
      );
    } else {
      success = await widget.bookProvider.addBook(fields, _selectedImagePath);
    }
    ...
    if (success) {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Text(
            widget.bookProvider.errorMessage ?? 'Operation failed.',
  ...
  Widget build(BuildContext context) {
    final isLoading = widget.bookProvider.isLoading;
                        ...
                        child: Center(
                          child: Container(
                            ...
                            child: _selectedImagePath != null
                                ...
                                ? Image.network(
                                    '${BookService.baseUrl}${_existingBook!.coverImage}',
                                    fit: BoxFit.cover,
                                    errorBuilder:
