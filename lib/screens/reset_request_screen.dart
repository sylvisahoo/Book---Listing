...
class ResetRequestScreen extends StatefulWidget {
  ...
  const ResetRequestScreen({super.key, required this.authProvider});
...
class _ResetRequestScreenState extends State<ResetRequestScreen> {
  ...
  Future<void> _handleRequest() async {
    ...
    final token = await widget.authProvider.requestPasswordReset(email);
    ...
    if (token != null) {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Text(
            widget.authProvider.errorMessage ?? 'An error occurred.',
